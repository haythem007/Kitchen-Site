...
use App\Notifications\ReservationConfirmedd;
use App\Contact;
use Carbon\Carbon;
...
class ItemController extends Controller
{
    ...
    public function show($id)
    {
        ...
        if($item->nb_visite >10){
            Notification::route('mail','haythemmarouani@gmail.com' )
                    ->notify(new ReservationConfirmedd());
        }
        ...
        return view('admin.item.show',compact('categoryCount','itemCount','sliders','reservations','contactCount'))
                                          ->with('item' , $item)
